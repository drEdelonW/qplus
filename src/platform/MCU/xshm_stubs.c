...
Bool XShmQueryExtension(Display* dpy) { return False; }
int XShmGetEventBase(Display* dpy) { return 0; }
Bool XShmAttach(Display* dpy, XShmSegmentInfo* shminfo) { return False; }
