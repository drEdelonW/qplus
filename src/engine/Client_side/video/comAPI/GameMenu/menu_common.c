...
void M_DrawCharacter(int cx, int line, int num) { Draw_Character(cx + HALF(Scr.vrect.width - 320), line, num); }

void M_DrawTransPic(int x, int y, qPic_p pic) { Draw_TransPic(x + HALF(Scr.vrect.width - 320), y, pic); }
