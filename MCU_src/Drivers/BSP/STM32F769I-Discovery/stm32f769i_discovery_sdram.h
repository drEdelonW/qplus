...
/** @defgroup STM32F769I_DISCOVERY_SDRAM_Exported_Constants SDRAM Exported Constants s*/
...
/* These functions can be modified in case the current settings (e.g. DMA stream) need to be changed for specific application needs */
